...
<html>
    ...
    <body class="RegisterationForm">
        ...
        <!--<input type="email" name="emailID" class="email" id="email" placeholder="Email" required><br/><br/>-->
		
		<input type="email" name="emailID" class="emailID" id="emailID" placeholder="Email" required><br/><br/>
            ...
            <div class="footer-col">
               <h4>SERVICES</h4>
                <ul>
				  ...
				  <li><a href="../Registeration form/ShowregisterDetails.php">User details</a></li>
                </ul>
              </div>
             <div class="footer-col">
               <h4>VEHICLE FLEET</h4>
