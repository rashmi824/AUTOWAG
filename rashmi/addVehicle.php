<?php session_start(); ?>
<?php require_once('inc/connection.php'); ?>//include database connection file//
<?php

$errors = array();//define the all the  variables//
$capacity = '';
$passenger = '';
$luggage = '';
$transmission = '';
...
if (isset($_POST['submit'])) {//check if form submitted,insert from data into users table//
